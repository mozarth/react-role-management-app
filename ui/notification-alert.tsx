...
export function NotificationAlert({
  ...
  useEffect(() => {
    if (visible) {
      ...
      // Manejar promesa para evitar errores en navegadores
      ...
      // Reproducir una voz sintetizada
  ...
  return (
    <div className="fixed top-4 right-4 z-50 animate-in fade-in slide-in-from-top-5 duration-300 max-w-sm w-full">
